...
namespace MBBMonopoly {
	...
	/// <summary>
	/// Summary for MeniuAssignPlayerNames4
	/// </summary>
	public ref class MeniuAssignPlayerNames4 : public System::Windows::Forms::Form
	{
	public:
		MeniuAssignPlayerNames4(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(MeniuAssignPlayerNames4::typeid));
			...
			this->AssignPlayerNames->TabIndex = 3;
			...
			this->Name = L"MeniuAssignPlayerNames4";
